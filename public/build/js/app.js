...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = aboutForm;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ajaxUtils__ = __webpack_require__(/*! ./ajaxUtils */ "./assets/js/ajaxUtils.js");


function aboutForm() {
    var formAboutTitle = $("#about_form_aboutTitle");
    var formAbout = $("#about_form_about");
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__ajaxUtils__["b" /* ajaxForm */])("about_form");
}
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = account;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ajaxUtils__ = __webpack_require__(/*! ./ajaxUtils */ "./assets/js/ajaxUtils.js");


function account() {
    Object(__WEBPACK_IMPORTED_MODULE_0__ajaxUtils__["b" /* ajaxForm */])("email_form");
    Object(__WEBPACK_IMPORTED_MODULE_0__ajaxUtils__["b" /* ajaxForm */])("password_form");
...
function setButtons() {
    $(".form-wrapper").on("click", function () {
        if (!$(this).hasClass("activeForm")) $(this).addClass("activeForm");
    });
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = admin;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ajaxUtils__ = __webpack_require__(/*! ./ajaxUtils */ "./assets/js/ajaxUtils.js");


function admin() {
    Object(__WEBPACK_IMPORTED_MODULE_0__ajaxUtils__["a" /* ajaxDelete */])($(".back-wrapper .project-wrapper .project .delete"), 3, true);
...
function swapProjectOrder(event) {
    ...
    var copySelf = $(this).clone();
    var copyOther = draggedDiv.clone();

    $(this).replaceWith(copyOther);
    draggedDiv.replaceWith(copySelf);

    var idA = $(this).find(".hidden-id").text();
    var idB = draggedDiv.find(".hidden-id").text();

    $.ajax({
        url: window.location.origin + "/admin/project/swapOrder/" + idA + "/" + idB,
        // success: function (data) {console.log(data)},
        error: function error(data, sdj, _error) {
            alert(_error);
        }
    });
...
/***/ "./assets/js/ajaxUtils.js":
/*!********************************!*\
  !*** ./assets/js/ajaxUtils.js ***!
  \********************************/
/*! exports provided: ajaxForm, ajaxDelete */
/*! exports used: ajaxDelete, ajaxForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["b"] = ajaxForm;
/* harmony export (immutable) */ __webpack_exports__["a"] = ajaxDelete;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__notifications__ = __webpack_require__(/*! ./notifications */ "./assets/js/notifications.js");
/**
...
function ajaxForm(formName) {
    var successDataFunction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

    $('form[name="' + formName + '"]').on('submit', function (event) {
        event.preventDefault();
        var urlForm = $(this).prop('action') ? $(this).prop('action') : window.location.href;
        loading(formName);
        $.post({
            url: urlForm,
            ...
            error: function error(data, thing, _error) {
                ajaxError(_error, formName);
            }
        });
    });
}
...
function ajaxSuccess(data, formName, successDataFunction) {
    var state = "finished";
    if (successDataFunction != null) successDataFunction(data);else {
        if (data["state"] == "success") {
            Object(__WEBPACK_IMPORTED_MODULE_0__notifications__["b" /* notice */])(data["message"]);
        } else {
            Object(__WEBPACK_IMPORTED_MODULE_0__notifications__["a" /* error */])(data["message"]);
...
function ajaxError(errorForm, formName) {
    Object(__WEBPACK_IMPORTED_MODULE_0__notifications__["a" /* error */])(errorForm);
...
function ajaxDelete(selector) {
    var parentHeight = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    var demandConfirmation = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;

    selector.on("click", function () {
        event.preventDefault();
        if (demandConfirmation && !confirm("Voulez vous vraiment faire ça?")) return;
        var urlDelete = $(this).prop('href');
        var div = $(this);
        $.ajax({
            url: urlDelete,
            success: function success(data) {
                for (var height = parentHeight; height > 0; height--) {
                    div = div.parent();
                }div.remove();
            },
            error: function error(data, fsd, _error2) {
                alert(_error2);
            }
        });
    });
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__gallery__ = __webpack_require__(/*! ./gallery */ "./assets/js/gallery.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__about__ = __webpack_require__(/*! ./about */ "./assets/js/about.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__project__ = __webpack_require__(/*! ./project */ "./assets/js/project.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__admin__ = __webpack_require__(/*! ./admin */ "./assets/js/admin.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__email__ = __webpack_require__(/*! ./email */ "./assets/js/email.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__account__ = __webpack_require__(/*! ./account */ "./assets/js/account.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__notifications__ = __webpack_require__(/*! ./notifications */ "./assets/js/notifications.js");
...
$(document).ready(function () {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_2__project__["a" /* default */])();
    Object(__WEBPACK_IMPORTED_MODULE_0__gallery__["a" /* default */])();
    Object(__WEBPACK_IMPORTED_MODULE_3__admin__["a" /* default */])();
    Object(__WEBPACK_IMPORTED_MODULE_4__email__["a" /* default */])();
    Object(__WEBPACK_IMPORTED_MODULE_5__account__["a" /* default */])();
});
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))
 ...
 */
function admin() {
  Object(__WEBPACK_IMPORTED_MODULE_0__ajaxUtils__["b" /* ajaxForm */])("mail_form");
}
...
function organizeAllGalleries() {
    var columnAsked = determineColumnsNeeded();
    $('.gallery').each(function (index, element) {
        if (columnAsked != galleryColumns) organizeGalleryImages($(element), columnAsked);
    });
...
function determineColumnsNeeded() {
    ...
    for (var i = 1; i < 5; i++) {
        if (width < galleryColumnsToSize[i]) return i;
    }
}

function placeImagesInContainer(gallery) {
    var container = gallery.find(".invisible-container")[0];
    gallery.find('.gallery-column a').each(function (index, element) {
        container.append(element);
    });
}

function setColumnVisibilities(gallery, columnAsked) {
    for (var i = 0; i < galleryMaxColumns; i++) {
        var display = i < columnAsked ? "flex" : "none";
...
function fillCollumns(gallery, columnAsked) {
    ...
    gallery.find('.invisible-container a').each(function (index, element) {
        $(columns[actualColumn]).append(element);
        if (columnAsked > 0) actualColumn = findSmallestCollumn(gallery, columnAsked);
    });
}
...
function findSmallestCollumn(gallery, columnAsked) {
    var smallest = 0;
    var columns = gallery.find('.gallery-column');
    for (var i = 1; i < columnAsked; i++) {
        if ($(columns[i]).height() < $(columns[smallest]).height()) smallest = i;
    }
...
/*!************************************!*\
  !*** ./assets/js/notifications.js ***!
  \************************************/
/*! exports provided: notice, primary, error, success, notifications */
/*! exports used: error, notice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["b"] = notice;
...
function notice(message) {
    var notif = $('<div class="notification"></div>').addClass('notice');
...
function primary(message) {
    var notif = $('<div class="notification"></div>').addClass('primary');
    notif.append($('<p></p>').text(message));
    setTimeout(function () {
        notif.remove();
    }, 5000);
...
function error(message) {
    var notif = $('<div class="notification"></div>').addClass('error');
    notif.append($('<p></p>').text(message));
    setTimeout(function () {
        notif.remove();
    }, 5000);
...
function success(message) {
    var notif = $('<div class="notification"></div>').addClass('success');
    notif.append($('<p></p>').text(message));
    setTimeout(function () {
        notif.remove();
    }, 5000);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = projectForm;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_huebee__ = __webpack_require__(/*! huebee */ "./node_modules/huebee/huebee.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ajaxUtils__ = __webpack_require__(/*! ./ajaxUtils */ "./assets/js/ajaxUtils.js");
...
function projectForm() {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__ajaxUtils__["b" /* ajaxForm */])("project_form");
    Object(__WEBPACK_IMPORTED_MODULE_1__ajaxUtils__["b" /* ajaxForm */])("artwork_form", function (data) {
        // let array = JSON.parse(data[0])
        $.each(data, function () {
            var artwork = JSON.parse(this)[0];
            addArtwork(artwork);
        });
    });

    Object(__WEBPACK_IMPORTED_MODULE_1__ajaxUtils__["a" /* ajaxDelete */])($(".artwork .delete"), 2, false);
    ajaxFront($(".gallery .button-primary"));
}

function HueBeePlugin() {
    var formProjectColor = $("#project_form_color");
    if ($(".color-input")[0] != null) {
        var huebee = new __WEBPACK_IMPORTED_MODULE_0_huebee___default.a('.color-input', {
            notation: 'hex',
            hues: 20,
            saturations: 3,
            shades: 10,
...
function ProjectDynamicEditing() {
    var formTitle = $("#project_form_name");
    var formDescription = $("#project_form_description");
...
function addArtwork(artwork) {
    var divArt = $('<div></div>').addClass("artwork");
    divArt.append($('<img />').attr("src", "/images/artwork/" + artwork.thumbnail));
    var divButton = $('<div></div>').addClass("buttons");
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__ajaxUtils__["a" /* ajaxDelete */])(divArt.find(".delete"), 2, false);
...
function ajaxFront(div) {
    div.on("click", function () {
        ...
        $.ajax({
            ...
            error: function error(data, fsd, _error) {
                alert(_error);
            }
        });
    });
